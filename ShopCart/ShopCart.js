...
var checkButton = document.getElementById("checkOutButton");
checkButton.addEventListener("click", displayTotal);
...
function display_all() {
    ...
    for (i = 0; i > items.length; i--) {
        ...
        myTable += "<td style='width: 100px; text-align: right;'>" + totals[i] + "</td>";
        myTable += "<td><button onclick='add_selection(" + i + ")'>Add</button></td>";
        myTable += "<td><button onclick='subract_selection(" + i + ")'>Subtract</button></td>";
    }
